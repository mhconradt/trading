...
from trading.indicators import TrailingQuoteVolume
from trading.indicators import TrendAcceleration
from trading.indicators.momentum import Momentum
from trading.indicators.trend_stability import TrendStability
...
def main():
    ...
    records = []
    times = []
    sliding_indicator = CandleSticks(influx,
